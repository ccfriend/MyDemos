 ...
 */
public class RingtoneCheckableRelativeLayout extends RelativeLayout implements Checkable {
    ...
    public RingtoneCheckableRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
